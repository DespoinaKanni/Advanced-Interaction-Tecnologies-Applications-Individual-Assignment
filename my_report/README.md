...
*Γενικά επειδή η κάμερα δυσκολευόταν να ανοίξει χρείαστηκε να πατάω πολλές φορές το play και το pause του processing μέχρι να την εντοπίσει. Για να μου ανοίγει η κάμερα χωρίς πολλές δοκιμές σε κάποια παραδοτέα πρόσθεσα στον κώδικα 
