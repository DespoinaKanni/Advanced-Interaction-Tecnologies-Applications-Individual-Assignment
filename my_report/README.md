...
Το μάθημα έχει 3 παραδοτέα εργασιών μέσω των οποίων γίνεται μια εκτεταμένη εισαγωγή σε θέματα απαιτήσεων χρήστη, σχεδίασης, πρωτοτυποποίησης και αξιολόγησης προηγμένων και φυσικών διεπαφών του χρήστη. Ακόμη, το εργαστήριο αφορά τον προγραμματισμό της Kinect για την ανάπτυξη φυσικών διεπαφών όπως οι ανθρώπινες κινήσεις. Οι γλώσσες προγραμματισμού είναι η Processing με την βιβλιοθήκη (SimpleOpenNI library) και η C#. Μέσα από τα παραδοτέα γίνεται η μάθηση και η εξάσκηση του κώδικα. 
...
Έβαλα την εντολή `if (tobj.getSymbolID()==0)` το όποιο αντιπροσωπεύει το `fiducial 0`, έτσι έκανα και με τα υπόλοιπα με αριθμούς 1,2,3 και 4. Οι κωδικοί fiducials αφορούν μια φωτογραφία που αποθήκευσα στο data και τις έχω προσθέσει διάφορες μορφοποιήσεις.
